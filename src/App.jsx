    ...
    <>
      ...
      <form>
          <div class="mb-3">
              ...
              <input type="text" className="form-control" id="author" placeholder="Inserisci il nome dell'autore">
          </div>
          ...
          <div class="mb-3">
              ...
              <textarea className="form-control" id="body" rows="5" placeholder="Scrivi il contenuto del post"></textarea>
          </div>
